...
export default [
  ...
  { icon: SoupKitchen, title: "Volunteer Experience", id: "volunteer-experience" },
  { icon: WorkspacePremium, title: "Certifications", id: "certifications" },
  { icon: Mail, title: "Contact Me", id: "contact" }
];
